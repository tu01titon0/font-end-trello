        ...
        <div style={{ backgroundColor: "#1a1a1a", padding: "20px 10px" }}>
          ...
          <div>
            <img
              ...
              src="/create_board.svg"
              style={{ backgroundImage: `url(/${backgroundBroad})` }}
            />
          </div>
          <Container>
            <form onSubmit={formCreateBoard.handleSubmit}>
                  ...
                  {COLORS_BG.map((url, index) => (
                    <Grid key={index}>
                      <label>
                        ...
                        />
                        <img
                          className="backgound-img bg-color"
                          src={"/" + url}
                          onClick={() => handleChange(url)}
                        />
                      </label>
              ...
              <Input
                ...
                value={formCreateBoard.values.title}
              />
              <Typography
                variant="h5"
                className="label-name"
              ...
              <Space wrap>
                <Select
                  ...
                  name="workspace"
                  onChange={(value) =>
                    formCreateBoard.setFieldValue("workspace", value)
                  }
              ...
              <Space wrap>
                <Select
                  ...
                  name="visibility"
                  onChange={(value) =>
                    formCreateBoard.setFieldValue("visibility", value)
                  }
